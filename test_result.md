...
agent_communication:
  - agent: "main"
    message: "All 4 feature tasks implemented. (1) Profit Dashboard: admin.py already had the profit calculation code; added profit/top_profitable/profit_categories to the return statement. dashboard.tsx updated with profit KPI cards (Today/Weekly/Monthly/Lifetime), Top Profitable Products list, Profit by Category list. (2) Admin Orders Profit: orders.py now snapshots selling_price/self_price/mrp in order items at creation time. orders.tsx OrderCard now shows Selling Price/MRP/Self Price breakdown + Order Profit highlight for delivered orders. (3) Profile: Wishlist MenuRow and wishlistCount state/fetch completely removed from profile.tsx. edit.tsx updated with headerBackTitle. (4) Pricing Audit: cartStore.ts subtotal() now uses selling_price??price; cart.tsx unit/line-total display updated to same formula. Please test all 4 tasks. Credentials: admin@dwaarit.com/Admin@123, demo@dwaarit.com/Demo@123."
  - agent: "testing"
